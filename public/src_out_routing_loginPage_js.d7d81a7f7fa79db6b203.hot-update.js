...
/* harmony import */ var _loginPage_src_serverInteraction_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_loginPage_src_serverInteraction_js__WEBPACK_IMPORTED_MODULE_1__);
...
class LoginPage {
   ...
   #signUp(event) {
      ...
      if (valid) {
         _loginPage_src_serverInteraction_js__WEBPACK_IMPORTED_MODULE_1___default().execSignUp(event);
         console.log('sending2backend...');  
