...
class Router {
   ...
   constructor(app) {
      ...
      if (frontpath === '/' || frontpath === '/out') {
         ...
         console.log('document.getElementById("warning"):', document.getElementById('warning'));
         if (routeinfoEl) {
         ...
         console.log('wantedpage (before nav):', wantedpage);
         this.navigate(wantedpage.slice(1));
         const userWarningEl = document.getElementById('warning');
         console.log('userWarningEl:', userWarningEl);
         if (userWarningEl) {
            console.log('userWarningEl.textContent:', userWarningEl.textContent);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("5fda83e46fa7acd0729c")
/******/ })();
/******/ 
/******/ }
);