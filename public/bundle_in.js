...
/* harmony import */ var _crypting_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./crypting.js */ "./src_in/crypting.js");
...
/***/ "./src_in/backendDataCommunication/keyDerivationPoster.js"
/*!****************************************************************!*\
  !*** ./src_in/backendDataCommunication/keyDerivationPoster.js ***!
  \****************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const fetchDerivedKeyBase64 = async saltBase64 => {
  ...
  const response = await fetch('/deriveKey', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (fetchDerivedKeyBase64);
...
class Chart {
  ...
  constructor(app) {
    ...
    this.chartOps = new _modals_src_chartOps_js__WEBPACK_IMPORTED_MODULE_0__["default"](app.appData);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _backendDataCommunication_keyDerivationPoster_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./backendDataCommunication/keyDerivationPoster.js */ "./src_in/backendDataCommunication/keyDerivationPoster.js");
...
class Crypting {
  ...
  getDecryptedLocals = async storeID => {
    ...
    try {
      ...
      return {
        dataAndTimeObj: localObj,
        decryPath: decryptedPath
      };
    } catch (e) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (crypting);
...
/* harmony import */ var _crypting_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./crypting.js */ "./src_in/crypting.js");
/* harmony import */ var _backendDataCommunication_keyDerivationPoster_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./backendDataCommunication/keyDerivationPoster.js */ "./src_in/backendDataCommunication/keyDerivationPoster.js");
...
class App {
  constructor() {
    ...
    _crypting_js__WEBPACK_IMPORTED_MODULE_8__["default"].timespan = this.timespan;
    this.storeID = null;
    ...
    this.appData = new _appData_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    _crypting_js__WEBPACK_IMPORTED_MODULE_8__["default"].appData = this.appData;
  ...
  async continueWithLocalDataFirst(storeID) {
    ...
    this.modal = new _modal_js__WEBPACK_IMPORTED_MODULE_6__["default"](this.appData, _modalContents_js__WEBPACK_IMPORTED_MODULE_7__.modalContents, this.chart);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _crypting_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./crypting.js */ "./src_in/crypting.js");
...
class Modal {
  ...
  constructor(appData, modalContents, chart) {
    ...
    this.modSub = new _modals_src_modalSubmitAllocator_js__WEBPACK_IMPORTED_MODULE_2__["default"](this.appData, chart);
...
/* harmony import */ var _backendDataCommunication_chartDataPoster_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../backendDataCommunication/chartDataPoster.js */ "./src_in/backendDataCommunication/chartDataPoster.js");
/* harmony import */ var _crypting_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../crypting.js */ "./src_in/crypting.js");
...
class ChartAdjuster {
  constructor(appData) {
    this.appData = appData;
    this.chartops = new _chartOps_js__WEBPACK_IMPORTED_MODULE_1__["default"](appData);
  }
...
class ModalSubmitAllocator {
  constructor(appData, chart) {
    ...
    this.bagSubmits = new _bagSubmits_js__WEBPACK_IMPORTED_MODULE_0__["default"](appData, chart, this.chartOps);
